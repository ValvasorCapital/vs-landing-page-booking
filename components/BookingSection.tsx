      ...
      <div className="relative max-w-7xl w-full mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-semibold tracking-tight leading-[1.1] mb-5">
            ...
            <span className="text-zinc-600 md:ml-3">{t.hero.headlineEnd}</span>
          </h1>
        ...
        <div className="mt-8 flex justify-center">
          <div className="flex items-center gap-6 md:gap-10 text-zinc-600">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] font-normal tracking-wider uppercase">{t.hero.encrypted}</span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] font-normal tracking-wider uppercase">{t.hero.secureLiaison}</span>
            </div>
          </div>
        </div>
      </div>
